...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: RecipePageWidget(
              recipe: params.getParam(
                  'recipe', ParamType.DocumentReference, false, ['recipes']),
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/createRecipe',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CreateRecipe')
              : NavBarPage(
                  initialPage: 'CreateRecipe',
                  page: CreateRecipeWidget(),
                ),
        )
...
extension NavigationExtensions on BuildContext {
  ...
  void safePop() {
    ...
    if (GoRouter.of(this).routerDelegate.matches.isNotEmpty) {
      go('/');
    } else {
      pop();
    }
